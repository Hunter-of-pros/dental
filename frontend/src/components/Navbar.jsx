      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <ul className="hidden lg:flex space-x-6 xl:space-x-8 items-center text-sm font-medium uppercase tracking-wider">
            ...
            >
              <button
                className={`uppercase tracking-wider font-medium transition-colors pb-1 ${
                  treatmentsOpen
      ...
      <div className={`lg:hidden transition-all duration-300 ease-in-out ${isOpen ? "max-h-screen opacity-100" : "max-h-0 opacity-0 overflow-hidden"}`}>
        <div className="px-4 pt-2 pb-6 bg-white border-t border-gray-100 shadow-inner">
          <ul className="flex flex-col text-center py-4">
            <li><NavLink to="/" onClick={closeMenu} className="block text-lg py-3">Home</NavLink></li>

            {/* Mobile Treatments Accordion */}
            <li>
              <button
                onClick={() => setMobileTreatmentsOpen(!mobileTreatmentsOpen)}
                className="w-full flex items-center justify-center gap-2 text-lg py-3 text-gray-900"
              >
                Treatments
              </button>
            ...
            <li><NavLink to="/patient-safety" onClick={closeMenu} className="block text-lg py-3">Safety</NavLink></li>
            <li><NavLink to="/doctors" onClick={closeMenu} className="block text-lg py-3">Doctors</NavLink></li>
            <li><NavLink to="/our-clinics" onClick={closeMenu} className="block text-lg py-3">Clinics</NavLink></li>
            <li><NavLink to="/contact-us" onClick={closeMenu} className="block text-lg py-3">Contact</NavLink></li>
